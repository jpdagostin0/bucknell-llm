...
def ping(_: dict[str, Any]) -> dict[str, Any]:
    result = google_ping()
    result["service"] = "google-calendar"
...
USAGE = {
    "upcoming": "upcoming [--days 14] [--query text] [--calendarId email]",
    "list_events": "list_events [--timeMin ISO] [--timeMax ISO] [--query text] [--maxResults 50]",
    "search_events": "search_events --query text [--timeMin ISO] [--timeMax ISO]",
    "get_event": "get_event --eventId ID",
    "list_calendars": "list_calendars",
    "create_event": "create_event --summary TITLE --startTime ISO --endTime ISO",
    "update_event": "update_event --eventId ID [--summary TITLE] [--startTime ISO] [--endTime ISO]",
    "delete_event": "delete_event --eventId ID",
    "suggest_time": "suggest_time [--durationMinutes 60] [--timeMin ISO] [--timeMax ISO]",
    "respond_to_event": "respond_to_event --eventId ID --response accepted|declined|tentative",
}


def main() -> int:
    os.environ.setdefault("OAUTHLIB_RELAX_TOKEN_SCOPE", "1")
    return run_cli("google-calendar", commands(), usage=USAGE)
