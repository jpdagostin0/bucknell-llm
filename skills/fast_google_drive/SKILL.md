---
name: fast_google_drive
description: Lists a class Google Drive content folder.
---
...
```text
python tools/run_tool/run_tool.py fast_google_drive commands
```

## Run

```text
python tools/run_tool/run_tool.py fast_google_drive --class "MATH 212"
```
