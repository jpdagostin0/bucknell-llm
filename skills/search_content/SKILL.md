---
name: search_content
description: Find vault files by glob and grep their text. Never search .env.yml.
---
...
```text
python tools/run_tool/run_tool.py search_content --path courses --pattern "linear:" --glob "*.md"
```
