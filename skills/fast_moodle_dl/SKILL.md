---
name: fast_moodle_dl
description: Downloads and inventories Moodle staging for a class. Never read Moodle secrets.
---
...
```text
python tools/run_tool/run_tool.py fast_moodle_dl commands
```

## Run

```text
python tools/run_tool/run_tool.py fast_moodle_dl --class "MATH 212"
```
