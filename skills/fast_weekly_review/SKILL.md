---
name: fast_weekly_review
description: Reviews inbox and unfinished Linear work. Never auto-set Missed.
---
...
```text
python tools/run_tool/run_tool.py fast_weekly_review commands
```

## Run

```text
python tools/run_tool/run_tool.py fast_weekly_review --class "MATH 212" --week 1
```
